...
/**
 * @author: XGLLHZ
 * @date: 2020/5/15 下午4:55
 * @description: logo 自动生成工具类
 * 注：线上使用时，若涉及到中文字体乱码现象，则应查看服务器是否有所设定的自体集 fc-list
 *    若没有，则应下载 .ttf 文件，上传至服务器字体目录下
 */
public class LogoUtil {
    ...
    public static String generateImg(String name) throws IOException {
        ...
        String logoUrl = randomNumber() + ".jpg";
        String filename = "/Users/xinou/Desktop/" + File.separator + logoUrl;
        ...
        if(nameWritten.length() >= 2) {
            font = new Font("微軟正黑體", Font.PLAIN, 30);
            g2.setFont(font);
        ...
        if(nameWritten.length() ==1) {
            ...
            if(isChinese(nameWritten)) {
                font = new Font("微軟正黑體", Font.PLAIN, 50);
                g2.setFont(font);
                g2.drawString(nameWritten, 25, 70);
            }
            //英文
            else {
                font = new Font("微軟正黑體", Font.PLAIN, 55);
                g2.setFont(font);
        ...
        //圆角处理
        BufferedImage bufferedImage = makeRoundedCorner(bi, 500);
